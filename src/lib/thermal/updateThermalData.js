...
const updateThermalDataInFile = (filePath) => {
    ...
    console.log(`Дані у файлі ${filePath} успішно оновлено!`);
};

const filePath = join(__dirname, '..', 'thermal', 'data.json'); // Вказано шлях до файлу
updateThermalDataInFile(filePath);
